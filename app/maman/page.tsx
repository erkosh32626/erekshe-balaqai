        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            >
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300">
                <p><strong>Аты-жөні:</strong> Шәрі Әлия Болатбекқызы</p>
                <p><strong>Мамандығы:</strong> Логопед</p>
                <p><strong>Тәжірибесі:</strong> 4 жылдан астам</p>
                <p><strong>Білімі:</strong> М. Мәметова атындағы Қызылорда педагогикалық жоғары колледжі (2024-2028)</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>• 100+ баланың сөйлеу дағдыларын дамыту</li>
          ...
          >
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Шәрі Элия Болатбекқызы М. Мәметова атындағы Қызылорда педагогикалық жоғары колледжінің түлегі. 
              Логопед мамандыгы эр өте балалардың сөйлеу дамуына көмектесуге нӀңайын. 
              Диагностика жүргізу, жеке бағдарламалар құру және отбасылармен жұмыс істеу менің негізгі қызметтерімнің бірі. 
              Балалардың әрқайсысына жеке көзқараспен қараймын және олардың қажеттіліктеріне сәйкес әдістер қолданамын.
            </p>
          </motion.div>
