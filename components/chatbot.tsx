...
const FAQ_DATA = [
  {
    ...
    answer: "Сәлеметсіз бе! Мен Erekshe Balaqai чат-ботымын. Сізге логопедия саласында көмектесуге дайынмын. Қандай сұрағыңыз бар?"
  },
  {
...
export function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "Сәлеметсіз бе! Мен Erekshe Balaqai чат-ботымын. Логопедия туралы сұрақтарыңызға жауап беремін. Не білгіңіз келеді?",
      isBot: true
    }
  ])
